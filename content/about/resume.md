...
```
{
  "basics": {
    ...
    "summary": "I am a DevOps Engnineer that focuses on automation of infrastructure.
    "website": "https://joshbergman.dev",
    "email": "josh@joshbergman.dev",
    "location": {
      "city": "Wilmington",
      "countryCode": "NC"
    },
    "profiles": [
      {
        "username": "b3rgman",
        "url": "https://github.com/b3rgman",
        "network": "github"
      },
      {
        "url": "https://gitlab.com/b3rgman",
        "username": "b3rgman",
        "network": "gitlab"
      },
        "url": "https://www.linkedin.com/in/josh-bergman-5104b988",
        "username": "josh-bergman",
        "network": "linkedin"
      }
    ]
  },
  ...
  "skills": [
    ...
    {
      "keywords": ["AWS", "Ansible", "Heroku", "Caching", "Jenkins"],
      "level": "Senior",
      "name": "Devops"
    }
  ],
  ...
  "interests": [
    ...
    {
      "name": "Automation / Machine Learning"
    },
    {
      "name": "Open Source / Developing"
    }
  ]
}
```
